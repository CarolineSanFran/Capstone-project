        ...
        <div className="row align-self-start">
          <div className="col-md-4 col-xs-12 col-sm-4">
            {this.state.tweetsLoaded ?
              ...
              <p> "Sorry, there seems to be an issue accessing Twitter. We'll try again a bit later."</p>
            }

          </div>
          <div className="col-md-4 col-xs-12 col-sm-4 twitter-tweet">
              Would you like to flag hate speech on Twitter too? 
              <button className="btn btn-primary" name="play" id="play" onClick={() => this.playSong2(this.state.currentSongID)}><i class="fab fa-twitter"></i> 
              Sign in to Twitter </button> 

              <i>We in no way see your login and password.</i>
