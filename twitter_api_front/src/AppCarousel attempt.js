    ...
    return (
      ...
      <div className="App">
        ...
        <div className="carousel">
          ...
          <img src="./img/love-by-fabrizio-verrecchia-195644-unsplash_Jumbotron.jpg" alt="love-by-fabrizio-verrecchia-195644 on unsplash" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Fight Hate Speech on Twitter</h5>
              <p>Po*n is freely accessible on Twitter.  It advocates not love, not sex, but violence, especially against women & teens. Here, flag those users with your Twitter account.  </p>
